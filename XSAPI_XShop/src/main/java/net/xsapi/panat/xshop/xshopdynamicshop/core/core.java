...
public final class core extends JavaPlugin {
    ...
    private boolean setupEconomy() {
        if (Bukkit.getPluginManager().getPlugin("Vault") == null) {
            Bukkit.getConsoleSender().sendMessage("§x§f§f§5§8§5§8[XSHOP] Vault Not Found!");
            return false;
        }
        ...
        for (Player p : Bukkit.getOnlinePlayers()) {
            if(p.getOpenInventory().getTitle() != null) {
                ...
                if(title.equalsIgnoreCase(config.customConfig.getString("gui.gui_title").replace("&", "§"))
                        ...
                        || title.equalsIgnoreCase(config.customConfig.getString("gui_confirm.title").replace("&", "§"))
    ...
    public static void loadData() {
        ...
        if (directoryListing != null) {
            for (File child : directoryListing) {
                if(child.getName().endsWith(".yml")) {
                    ...
                    File file = new File(core.getPlugin().getDataFolder() + "/shops", child.getName());
                               ...
                               // Bukkit.getLogger().info(item + "." + itemList + ".type" + "   FILE " + Name + "SIze: " + fileConfig.getConfigurationSection(item).getKeys(false).size());
                                if(fileConfig.getString(item + "." + itemList + ".type").equals("CUSTOM")) {
                                    ...
                                    if(fileConfig.get(item + "." + itemList + ".customTags") != null) {
                                        ...
                                        if(customTags.startsWith("XS_SEASON") || customTags.startsWith("XS_FISH") || customTags.startsWith("XS_FOODS")) {
                                    ...
                                    if(fileConfig.get(item + "." + itemList + ".customItemsStorage") != null) {
                                        ...
                                        if(storages.customConfig.get(nameStorage) == null) {
                                            Bukkit.getConsoleSender().sendMessage(("&c[Xshop] Cannot load item &e" + itemList + " &cthis customStorage name is NULL").replace("&","§"));
                                            continue;
                                        }
                                    ...
                                    if(mat == null) {
                                        if(fileConfig.get(item + "." + itemList + ".customItemsStorage") == null) {
                                            Bukkit.getConsoleSender().sendMessage(("&c[Xshop] Cannot load item &e" + itemList + " &cthis item setup not complete!").replace("&","§"));
                                            continue;
                                        }
                                    }

                                    if(priceType == null) {
                                        Bukkit.getConsoleSender().sendMessage(("&c[Xshop] Cannot load item &e" + itemList + " &cprice type is null!").replace("&","§"));
                                        continue;
                                    }
                                    ...
                                    if(fileConfig.get(item + "." + itemList + ".customItemStorageSell") != null) {
                                        if(xsitemscustom.getStorageName().isEmpty()) {
                                            Bukkit.getConsoleSender().sendMessage(("&c[Xshop] Cannot load item &e" + itemList + " &ccustomItemStorageSell is true but not have customItemsStorage!").replace("&","§"));
                                            continue;
                                        }
                                    ...
                                    if(fileConfig.get(item + "." + itemList + ".customType") == null) {
                                        Bukkit.getConsoleSender().sendMessage(("&c[Xshop] Cannot load item &e" + itemList + " &ccustomType is NULL!").replace("&","§"));
                                        continue;
                                    } else {
                                    ...
                                    if(!season.isEmpty()) {
                                        ...
                                        } else if(Name.equalsIgnoreCase("foods")) {
                                            foodsShops.add(xsitemscustom);
        ...
        Bukkit.getConsoleSender().sendMessage("§x§f§f§a§c§2§f[XShop] Successfully load " + shops + " shop(s) with " + items + " item(s)");
    }
    ...
    public static void saveData() {
        for(XShopDynamic shop : shopList) {
            ...
            try {
                ...
                Bukkit.getConsoleSender().sendMessage("&c[XShop] Cannot save data file is null!");
                return;
            }
        ...
        Bukkit.getConsoleSender().sendMessage("§x§f§f§a§c§2§f[XShop] Successfully saved shop(s) data!");
    }
    ...
    public void onEnable() {
        if (!setupEconomy()) {
            Bukkit.getConsoleSender().sendMessage("§x§f§f§5§8§5§8[XSHOP] Disabled due to no Vault dependency found!");
            Bukkit.getPluginManager().disablePlugin(this);
            return;
        } else {
            Bukkit.getConsoleSender().sendMessage("§x§f§f§c§e§2§2[XSHOP] Vault: §x§5§d§f§f§6§3Hook");
        }
        ...
        if (this.ppAPI != null) {
            Bukkit.getConsoleSender().sendMessage("§x§f§f§c§e§2§2[XSHOP] PlayerPoint: §x§5§d§f§f§6§3Hook");
        } else {
            Bukkit.getConsoleSender().sendMessage("§x§f§f§c§e§2§2[XSHOP] PlayerPoint: §x§f§f§5§8§5§8Not Hook");
        }

        if (this.xsseasonsAPI != null) {
            Bukkit.getConsoleSender().sendMessage("§x§f§f§c§e§2§2[XSHOP] XSSeasons: §x§5§d§f§f§6§3Hook");
            Bukkit.getPluginManager().registerEvents(new SeasonsChangeEvent(),this);
        } else {
            Bukkit.getConsoleSender().sendMessage("§x§f§f§c§e§2§2[XSHOP] XSSeasons: §x§f§f§5§8§5§8Not Hook");
        }
        ...
        if(config.customConfig.getBoolean("reset_price.enable")) {
            Bukkit.getConsoleSender().sendMessage("§x§f§f§c§e§2§2[XSHOP] ResetPrice: §x§5§d§f§f§6§3Enabled");

            File directory = new File(plugin.getDataFolder() + "/temp");

            if(!directory.exists()) {
                Bukkit.getConsoleSender().sendMessage("§x§5§d§f§f§6§3[XSHOP] temp file empty create new one...");
                ...
                Bukkit.getConsoleSender().sendMessage("§x§5§d§f§f§6§3[XSHOP] create temp file successful!");
                ...
                Bukkit.getConsoleSender().sendMessage("§x§f§f§5§8§5§8[XSHOP] temp file already exists!");

                if(System.currentTimeMillis()-config.customConfig.getLong("reset_price.time_stamp") >= 0L) {
                    new ResetPriceFeatures().resetPrice();
                    core.loadData();
                    Bukkit.getConsoleSender().sendMessage("§x§f§f§a§c§2§f[XShop] reset price tasks successfully!");
                }

            }

        } else {
            Bukkit.getConsoleSender().sendMessage("§x§f§f§c§e§2§2[XSHOP] ResetPrice: §x§f§f§5§8§5§8Disabled");
        }

        Bukkit.getConsoleSender().sendMessage("§x§f§f§a§c§2§f******************************");
        Bukkit.getConsoleSender().sendMessage("§x§f§f§a§c§2§f   XSAPI DynamicShop v1.0     ");
        Bukkit.getConsoleSender().sendMessage("§r");
        Bukkit.getConsoleSender().sendMessage("§x§f§f§a§c§2§f  Trying to load shop(s) data");
        Bukkit.getConsoleSender().sendMessage("§r");
        Bukkit.getConsoleSender().sendMessage("§x§f§f§a§c§2§f******************************");
        loadData();
    ...
    public void onDisable() {
        ...
        Bukkit.getConsoleSender().sendMessage("§x§f§f§a§c§2§f   XSAPI DynamicShop v1.0     ");
        Bukkit.getConsoleSender().sendMessage("§r");
        Bukkit.getConsoleSender().sendMessage("§x§f§f§a§c§2§f  Thank you for using this plugin");
        Bukkit.getConsoleSender().sendMessage("§r");
        Bukkit.getConsoleSender().sendMessage("§x§f§f§a§c§2§f******************************");
        saveData();
        core.closeInventory();
