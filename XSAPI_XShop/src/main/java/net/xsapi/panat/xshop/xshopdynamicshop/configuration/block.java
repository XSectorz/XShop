...
public class block {
    ...
    public void loadConfigu() {
        customConfigFile = new File(core.getPlugin().getDataFolder() + "/shops", "block.yml");
        if (!customConfigFile.exists()) {
            customConfigFile.getParentFile().mkdirs();
            core.getPlugin().saveResource("shops/block.yml", false);
        }
    ...
    public static void reload() {
        config.customConfigFile = new File(core.getPlugin().getDataFolder() + "/shops", "block.yml");
