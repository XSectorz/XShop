...
public class block {
    ...
    public void loadConfigu() {
        customConfigFile = new File(XShopDynamicShopCore.getPlugin().getDataFolder() + "/shops", "block.yml");
        if (!customConfigFile.exists()) {
            customConfigFile.getParentFile().mkdirs();
            XShopDynamicShopCore.getPlugin().saveResource("shops/block.yml", false);
        }
    ...
    public static void reload() {
        config.customConfigFile = new File(XShopDynamicShopCore.getPlugin().getDataFolder() + "/shops", "block.yml");
