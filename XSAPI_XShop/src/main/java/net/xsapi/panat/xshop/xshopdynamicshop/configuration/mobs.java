...
public class mobs {
    ...
    public void loadConfigu() {
        customConfigFile = new File(core.getPlugin().getDataFolder() + "/shops", "mobs.yml");
        if (!customConfigFile.exists()) {
            customConfigFile.getParentFile().mkdirs();
            core.getPlugin().saveResource("shops/mobs.yml", false);
        }
    ...
    public static void reload() {
        config.customConfigFile = new File(core.getPlugin().getDataFolder() + "/shops", "mobs.yml");
