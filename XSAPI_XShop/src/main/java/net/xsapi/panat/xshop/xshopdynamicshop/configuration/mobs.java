...
public class mobs {
    ...
    public void loadConfigu() {
        customConfigFile = new File(XShopDynamicShopCore.getPlugin().getDataFolder() + "/shops", "mobs.yml");
        if (!customConfigFile.exists()) {
            customConfigFile.getParentFile().mkdirs();
            XShopDynamicShopCore.getPlugin().saveResource("shops/mobs.yml", false);
        }
    ...
    public static void reload() {
        config.customConfigFile = new File(XShopDynamicShopCore.getPlugin().getDataFolder() + "/shops", "mobs.yml");
