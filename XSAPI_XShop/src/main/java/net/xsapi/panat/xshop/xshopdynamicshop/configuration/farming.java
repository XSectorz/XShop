...
public class farming {
    ...
    public void loadConfigu() {
        customConfigFile = new File(XShopDynamicShopCore.getPlugin().getDataFolder() + "/shops", "farming.yml");
        if (!customConfigFile.exists()) {
            customConfigFile.getParentFile().mkdirs();
            XShopDynamicShopCore.getPlugin().saveResource("shops/farming.yml", false);
        }
    ...
    public static void reload() {
        config.customConfigFile = new File(XShopDynamicShopCore.getPlugin().getDataFolder() + "/shops", "farming.yml");
